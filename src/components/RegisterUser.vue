           ...
           <div class="wrap-login100">
               ...
               <form class="login100-form validate-form">
                   ...
                   <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                       <input class="input100" type="text" v-model="name" placeholder="Full name" >
                   ...
                   <div class="alert alert-dismissible fade show" :class="passwordStatus" role="alert" v-if="msg && confirmPassword.length > 0">
    ...
    methods:{
        comparePassword(){
            if(this.password == this.confirmPassword){
                ...
                this.passwordStatus = 'alert-success'
            }else{
                this.msg = "Password not matched"
                this.passwordStatus = 'alert-danger'
